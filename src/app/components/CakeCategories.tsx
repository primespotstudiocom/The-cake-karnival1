        ...
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="min-w-0">
              <p className="text-xs font-semibold tracking-[0.22em] text-[#96028b]">ORDER ON WHATSAPP</p>
                  ...
                  return (
                    <motion.button
                      ...
                      className={[
                        ...
                        isActive
                          ? 'border-primary bg-primary text-primary-foreground shadow-[0_10px_24px_rgba(150,2,139,0.25)]'
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-primary px-6 py-4 text-sm font-semibold tracking-[0.14em] text-primary-foreground shadow-[0_18px_40px_rgba(150,2,139,0.26)] transition-all hover:bg-accent hover:text-accent-foreground hover:shadow-[0_22px_48px_rgba(150,2,139,0.30)]"
              >

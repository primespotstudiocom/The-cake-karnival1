...
export function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed inset-x-0 top-0 z-50 border-b border-black/5 bg-[linear-gradient(90deg,rgba(250,244,248,0.94)_0%,rgba(254,218,117,0.22)_16%,rgba(250,126,30,0.18)_34%,rgba(214,41,118,0.14)_62%,rgba(150,47,191,0.16)_100%)] backdrop-blur-md"
    >
      <div className="max-w-7xl mx-auto px-4 py-2 sm:px-6 sm:py-3">
        ...
        {isMobileMenuOpen ? (
          <div className="mt-4 rounded-3xl border border-[#ead8d0] bg-[linear-gradient(135deg,rgba(250,244,248,0.96)_0%,rgba(254,218,117,0.24)_18%,rgba(250,126,30,0.18)_38%,rgba(214,41,118,0.14)_68%,rgba(150,47,191,0.16)_100%)] p-3 shadow-[0_18px_40px_rgba(25,16,10,0.08)] backdrop-blur md:hidden">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      ...
                      isActive ? 'bg-[#fff0f6] text-[#D62976]' : 'text-foreground/80 hover:bg-[#fff6fb] hover:text-foreground',
                    ].join(' ')
                  }
                >
                  {item.label}

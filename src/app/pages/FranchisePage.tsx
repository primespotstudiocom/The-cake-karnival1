  ...
  return (
    <>
      <section className="instagram-section relative overflow-hidden pb-10 pt-6 sm:pt-8">
        ...
        <div className="pointer-events-none absolute -right-16 top-6 h-80 w-80 rounded-full bg-[#F4A641]/16 blur-3xl" />
          ...
          >
            <div className="max-w-3xl">
              <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#e3cfc8] bg-white/75 px-4 py-1 text-xs font-semibold tracking-[0.18em] text-[#b45f4f]">
                ...
                <span className="inline-block h-1.5 w-1.5 rounded-full bg-[#FA7E1E]" />
              </p>
              ...
              <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
                {pillars.map((pillar, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-[#fff7ef] text-[#FA7E1E]">
            ...
            >
              ...
              <div className="absolute -right-6 bottom-10 hidden h-32 w-32 rounded-full bg-[#F4A641]/16 blur-3xl lg:block" />
      ...
      <section className="instagram-section pb-24 pt-6">
        <div className="mx-auto max-w-7xl px-6">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                  <div className="rounded-2xl border border-[#ece3de] bg-[#fffdfc] p-5">
                    <div className="mb-4 flex items-center gap-3">
                      <MessageCircle className="size-5 text-[#FA7E1E]" />
                      <div className="text-xs font-semibold tracking-[0.18em] text-[#FA7E1E] uppercase">Contact</div>
                    </div>
                    <div className="space-y-3 text-sm text-[#777]">
                      <div className="flex items-start gap-3">
                        <Mail className="mt-0.5 size-4 text-[#FA7E1E]" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <MessageCircle className="mt-0.5 size-4 text-[#FA7E1E]" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Phone className="mt-0.5 size-4 text-[#FA7E1E]" />
                        <div>
                  ...
                  <div className="rounded-2xl border border-[#ece3de] bg-[#fffdfc] p-5">
                    <div className="mb-4 flex items-center gap-3">
                      <ClipboardList className="size-5 text-[#FA7E1E]" />
                      <div className="text-xs font-semibold tracking-[0.18em] text-[#FA7E1E] uppercase">Information</div>
                    </div>
                    <div className="space-y-3 text-sm text-[#777]">
                      <div>
                  ...
                  <div className="rounded-2xl border border-[#ece3de] bg-[#fffdfc] p-5">
                    <div className="mb-4 flex items-center gap-3">
                      <Video className="size-5 text-[#FA7E1E]" />
                      <div className="text-xs font-semibold tracking-[0.18em] text-[#FA7E1E] uppercase">Media</div>
                    </div>
                  ...
                  <div className="rounded-2xl border border-[#ece3de] bg-[#fffdfc] p-5">
                    <div className="mb-4 flex items-center gap-3">
                      <FileSpreadsheet className="size-5 text-[#FA7E1E]" />
                      <div className="text-xs font-semibold tracking-[0.18em] text-[#FA7E1E] uppercase">CRM</div>
                    </div>
                    <div className="space-y-3 text-sm text-[#777]">
                      <div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-[#dddddd] bg-[#fafafa] py-3 pl-9 pr-4 text-[#2d2d2d] outline-none transition-all placeholder:text-[#9a9a9a] focus-visible:border-[#FA7E1E] focus-visible:ring-[3px] focus-visible:ring-[#FA7E1E33]"
                      />
                    </div>
                  </div>
                </div>
          ...
          >
            <p className="text-xs font-semibold tracking-[0.22em] text-[#FA7E1E]">HOW IT WORKS</p>
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-4">
              {setupSteps.map((step, idx) => (
                <div key={step.title} className="rounded-2xl border border-[#f0e3dc] bg-white p-5">
                  <div className="mb-2 text-xs font-semibold tracking-[0.18em] text-[#FA7E1E]">STEP {idx + 1}</div>

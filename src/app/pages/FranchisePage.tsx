  ...
  return (
    <>
      <section className="instagram-section relative overflow-hidden pb-10 pt-6 sm:pt-8">
        <div className="pointer-events-none absolute -left-20 top-0 h-72 w-72 rounded-full bg-[#e9d5ff]/25 blur-3xl" />
        <div className="pointer-events-none absolute -right-16 top-6 h-80 w-80 rounded-full bg-[#b633a9]/16 blur-3xl" />
          ...
          >
            <div className="max-w-3xl">
              <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#e3cfc8] bg-white/75 px-4 py-1 text-xs font-semibold tracking-[0.18em] text-[#b45f4f]">
                ...
                <span className="inline-block h-1.5 w-1.5 rounded-full bg-[#96028b]" />
              </p>
              ...
              <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
                {pillars.map((pillar, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-[#fff7ef] text-[#96028b]">
            ...
            >
              <div className="absolute -left-6 top-10 hidden h-28 w-28 rounded-full bg-[#96028b]/20 blur-3xl lg:block" />
              <div className="absolute -right-6 bottom-10 hidden h-32 w-32 rounded-full bg-[#b633a9]/16 blur-3xl lg:block" />
      ...
      <section className="instagram-section pb-24 pt-6">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                  <div className="rounded-2xl border border-[#ece3de] bg-[#fffdfc] p-5">
                    <div className="mb-4 flex items-center gap-3">
                      <MessageCircle className="size-5 text-[#96028b]" />
                      <div className="text-xs font-semibold tracking-[0.18em] text-[#96028b] uppercase">Contact</div>
                    </div>
                    <div className="space-y-3 text-sm text-[#777]">
                      <div className="flex items-start gap-3">
                        <Mail className="mt-0.5 size-4 text-[#96028b]" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <MessageCircle className="mt-0.5 size-4 text-[#96028b]" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Phone className="mt-0.5 size-4 text-[#96028b]" />
                        <div>
                  ...
                  <div className="rounded-2xl border border-[#ece3de] bg-[#fffdfc] p-5">
                    <div className="mb-4 flex items-center gap-3">
                      <ClipboardList className="size-5 text-[#96028b]" />
                      <div className="text-xs font-semibold tracking-[0.18em] text-[#96028b] uppercase">Information</div>
                    </div>
                    <div className="space-y-3 text-sm text-[#777]">
                      <div>
                  ...
                  <div className="rounded-2xl border border-[#ece3de] bg-[#fffdfc] p-5">
                    <div className="mb-4 flex items-center gap-3">
                      <Video className="size-5 text-[#96028b]" />
                      <div className="text-xs font-semibold tracking-[0.18em] text-[#96028b] uppercase">Media</div>
                    </div>
                  ...
                  <div className="rounded-2xl border border-[#ece3de] bg-[#fffdfc] p-5">
                    <div className="mb-4 flex items-center gap-3">
                      <FileSpreadsheet className="size-5 text-[#96028b]" />
                      <div className="text-xs font-semibold tracking-[0.18em] text-[#96028b] uppercase">CRM</div>
                    </div>
                    <div className="space-y-3 text-sm text-[#777]">
                      <div>
            ...
            <div className="rounded-3xl border border-[#e6ddd8] bg-white p-8 shadow-[0_14px_34px_rgba(10,10,10,0.05)]">
              <div className="mb-4 inline-flex items-center gap-2 text-xs font-semibold tracking-[0.2em] text-[#96028b] uppercase">
                Franchise Inquiry
                <span className="inline-block h-2 w-2 rounded-full bg-[#96028b]/70" />
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-[#dddddd] bg-[#fafafa] px-4 py-3 text-[#2d2d2d] outline-none transition-all placeholder:text-[#9a9a9a] focus-visible:border-[#96028b] focus-visible:ring-[3px] focus-visible:ring-[#96028b33]"
                  />
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-[#dddddd] bg-[#fafafa] py-3 pl-9 pr-4 text-[#2d2d2d] outline-none transition-all placeholder:text-[#9a9a9a] focus-visible:border-[#96028b] focus-visible:ring-[3px] focus-visible:ring-[#96028b33]"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full resize-none rounded-xl border border-[#dddddd] bg-[#fafafa] px-4 py-3 text-[#2d2d2d] outline-none transition-all placeholder:text-[#9a9a9a] focus-visible:border-[#96028b] focus-visible:ring-[3px] focus-visible:ring-[#96028b33]"
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-[#1f1f1f] bg-[#1f1f1f] px-6 py-4 text-sm font-semibold tracking-[0.12em] text-white transition-colors hover:border-[#96028b] hover:bg-[#96028b]"
                >
          ...
          >
            <p className="text-xs font-semibold tracking-[0.22em] text-[#96028b]">HOW IT WORKS</p>
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-4">
              {setupSteps.map((step, idx) => (
                <div key={step.title} className="rounded-2xl border border-[#f0e3dc] bg-white p-5">
                  <div className="mb-2 text-xs font-semibold tracking-[0.18em] text-[#96028b]">STEP {idx + 1}</div>
